...
These are the default settings in :file:`ariane/manage.py`.
...
:py:class:`ariane.config.settings.common.Common`.
...
.. list-table::
    ...
    * - ``STATIC_ROOT``
      - ``'<full path to ariane>/static_root/'``
      - ``DJANGO_STATIC_ROOT``
...
:py:class:`ariane.config.settings.databases.Databases`.

The following classes inherit from it:

* :py:class:`ariane.config.settings.dev.Development`
* :py:class:`ariane.config.settings.public.Production`
* :py:class:`ariane.config.settings.public.Staging`
* :py:class:`ariane.config.settings.test.Testing`
...
:py:class:`ariane.config.settings.email.SMTP`
...
from :py:class:`ariane.config.settings.email.Mailgun`
to use these settings.
...
from :py:class:`ariane.config.settings.public.Raven`
to use these settings.
...
The class
:py:class:`ariane.config.settings.public.Public`
...
from :py:class:`ariane.config.settings.public.SSL`
to use these settings.
:py:class:`ariane.config.settings.public.Production`
